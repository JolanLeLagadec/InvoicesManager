...
export default function InvoiceItem() {
    return (
        <>
            <div className='hidden w-full bg-slate-800 p-5 lg:flex justify-between rounded-xl items-center  '>
            ...
            <div className='w-full bg-slate-800 p-5 flex justify-between rounded-xl items-center  lg:hidden'>
                <div className='flex flex-col justify-between items-start h-full gap-6'>
                    <h1 className='text-white font-bold'><span className='text-slate-500'>#</span>XM9141</h1>
                    <div className='flex flex-col '>
                        <span className='text-slate-500 font-light text-sm'>Due 20 Sept 2021</span>
                        <span className='text-white font-light text-sm  '>Alex Grim</span>
                    </div>

                </div>
                <div className='flex flex-col gap-6 items-center'>
                    <span className='text-white font-bold '>102.04€</span>
                    <span className='p-2 rounded-lg bg-[#2b2736] flex justify-center items-center text-[#FF8F00] gap-2'><div className='bg-[#FF8F00] rounded-full h-2 w-2'></div><span>Pending</span></span>
                </div>
            </div>
        </>
